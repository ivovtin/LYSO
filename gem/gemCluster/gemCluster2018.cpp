...
int main(int argc, char * argv[]) 
{
    ...
    UInt_t frame2 = ha->GetMaximumBin()-15;
    ha->SetAxisRange(32,47.5);
    UInt_t frame3 = ha->GetMaximumBin()-31;
    ha->SetAxisRange(48,64);
    UInt_t frame4 = ha->GetMaximumBin()-47;
	...
	//	new gem::ThickDetector(0),
		new gem::ThinDetector(0,frame1),
		new gem::ThinDetector(1,frame2),
		new gem::ThinDetector(2,frame3),
		new gem::ThinDetector(3,frame4) };
